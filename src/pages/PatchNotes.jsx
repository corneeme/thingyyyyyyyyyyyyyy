          ...
          <ul className='updates-list'>
            <li className='category'>
              ...
              <ul className='category-updates'>
                <li>
                  New Mobs, Weapons and Mutations that all interact (more or
                  less) with the Curse mechanic!
                </li>
                <li>
                ...
                <li>
                  ...
                  <br />
                  <br />
                  Cursed Flask. The Health Flask no longer consumes a charge
                  when used, but will give you 10 Curses instead.
                  <br />
                  <br />
                  Damned Vigor. Prevents your death and puts you at 1 HP. You
                  have 2 seconds to kill an enemy to save yourself, otherwise
                ...
                <li>
                  ...
                  can ring her bell to stun you. If she hits you with more than
                  50 curses, you die.
                  <br />
                  <br />
                  Those mobs are a bit special, as they don't have a specific
                  biomes in which they spawn. Instead, depending on the Boss
                  Cells level, they have a small chance of appearing in any
                  biome:
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  In 2BC, Sore Loser and Curser can spawn in biomes at depth 4
                  or more, while Doom Bringer can spawn in biomes at depth 5 or
                  more.
                  <br />
                  <br />
            ...
            <li className='category'>
              ...
              <ul className='category-updates'>
                ...
                <li>
                  ...
                  <br />
                  <br />
                  Each consecutive parry will reduce the cooldown of the skill
                ...
                <li>
                  ...
                  <br />
                  <br />
                  Holding the shield button will charge a stronger version of
                  the dash, which can then be used by releasing the button.
                </li>
                <li>
                ...
                <li>
                  Reduced Dracula's Castle (late) scroll fragments count, to
                  match other biomes at the same depth.
                  <span className='sub-patch'>Update 35.3</span>
                </li>
                <li>
                ...
                <li>
                  Fixed Mimic despawning when trying to jump a very long
                  distance.
            ...
            <li className='category'>
              ...
              <ul className='category-updates'>
                ...
                <li>
                  Replaced the exit to Fractured Shrines in Defiled Necropolis
                  by an exit to Graveyard.
                </li>
                <li>
                  Added a light source in the Mimic Hint lore room, when it
                  spawns in Forgotten Sepulcher.
                </li>
                <li>
            ...
            <li className='category'>
              ...
              <ul className='category-updates'>
                ...
                <li>
                  ...
                  display (Xbox, PS4, etc). By default, the game auto-detects
                  the type of controller used by the player, but that can be
            ...
            <li className='category'>
              ...
              <ul className='category-updates'>
                <li>
                  Added new input options for the "going through platform"
                  action.
                </li>
                <li>
                ...
                <li>
                  Split the "controller sticks deadzone" into two options, one
                  for each stick.
                </li>
                <li>Added an outline option for spikes.</li>
                <li>Added a button to center the minimap on the player.</li>
                <li>
                  Removed the "Leave the Body" prompt of the throne fountain,
                  when at 5BC. <span className='sub-patch'>Update 35.3</span>
                </li>
              </ul>
            </li>
            <li className='category'>
              ...
              <ul className='category-updates'>
                ...
                <li>
                  Improved stability of Dracula's Castle (late) generation,
                  which should fix some seeds crashing on loading the level.
                </li>
                <li>
                  Fixed a crash when opening the world map after opening the
                  Bank chest.
                </li>
                <li>
                  Fixed Wings of the Crow not triggering the "landing" state
                  when touching the ground.
                </li>
                <li>
                  Fixed being able to freeze yourself by using the Face Flask
                  with a "freeze on hit" necklace.
                </li>
                <li>
                  Fixed the ground stomp doing abysmal damage to flying enemies.
                </li>
                <li>
                  Fixed a bug where using Boy's Axe on Hand of the King would
                  get him stuck in place.
                </li>
                ...
                <li>
                  Fixed Medusa's Head being able to duplicate Biters. what?
                </li>
                <li>
                  Fixed not being able to use the Boss Cell after beating
                  Dracula.
                </li>
                ...
                <li>
                  Fixed Dracula being able to throw the player outside the
                  arena.
                </li>
                <li>
                  Fixed Foresight not triggering during the Assault Shield's
                  dash.
                </li>
                <li>
                  Fixed Master's Keep stairs being in the foreground in Boss
                  Rush.
                </li>
                <li>
                  Fixed the map being displayed in the Mutation selection
                  screen.
                </li>
                <li>
                  Fixed the Homonculus not using the "hold to jump" option.
                </li>
                <li>Fixed Face Flask preventing flawless achievements</li>
                <li>
                  Fixed the grenade summoned from some affixes being able to
                  stun the player when hitting a Thorny.
                </li>
                <li>
                  Reverted backpack to its own key binding, instead of being
                  tied with interact.
                </li>
                <li>
                ...
                <li>
                  Fixed buggy voice lines when getting Castlevania outfits
                  through the "Random Outfit Every Level" Custom Mode option.
                </li>
                <li>
                  Fixed Wish not working on Machete & Pistol in some cases
                </li>
                <li>
                  Fixed The Crown background music playing after the Queen
                  revives the player.
                </li>
                <li>Fixed Legendary Affixes not applying affix exclusivity.</li>
                <li>
                  Fixed Kleio looking the wrong way during their intro
                  animation.
                </li>
                <li>
                ...
                <li>
                  Fixed Legendary Hayabusa Gauntlets DPS display being
                  inaccurate.
                </li>
                <li>
                  Fixed a crash when exiting the game while Medusa was
                  performing her Petrification attack.
                  <span className='sub-patch'>Update 35.1</span>
                </li>
                <li>
                ...
                <li>
                  Fixed Boss Cell doors being able to generate after the Ram
                  Rune gate in Dracula's Castle.
                  <span className='sub-patch'>Update 35.3</span>
                </li>
                <li>
                ...
                <li>
                  Fixed Back Arrows, Front Arrows and Up Arrows, from the
                  affixes, sometimes spawning at different heights.
                  <span className='sub-patch'>Update 35.3</span>
                </li>
                <li>
                  Fixed some head particle effects still appearing on outfits
                  that already have a head.
                  <span className='sub-patch'>Update 35.3</span>
                </li>
                <li>
          ...
          <ul>
            ...
            <li>
              <div className='update-line'>
                ...
                <span className='alpha-branch'>beta branch</span>
              </div>
